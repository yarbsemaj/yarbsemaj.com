...
export const CrtShader = {
  uniforms: {
    ...
    shadowMask: { type: 'float', value: 4.0 }
  },
  vertexShader: /*glsl*/ `
    varying vec2 vUv;
...
#define brightboost 8.0
uniform float shadowMask;  // 1, 2, 3 or 4 (CRT style)
...
void main(){
  vec2 fragCoord = vUv * iResolution;
    ...
    gl_FragColor.rgb=pow(gl_FragColor.rgb,vec3(1.2))*brightboost;

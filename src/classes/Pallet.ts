...
export default class ColorPalette {
    ...
    hue: number
    baseColor: number
    complimentaryColor1: number
    complimentaryColor2: number
    colorChoices: Array<number>
    ...
    randomColor() {
        // pick a random color
        return this.colorChoices[~~random(0, this.colorChoices.length)].toString().replace(
            '#',
            '0x'
        );
    }
